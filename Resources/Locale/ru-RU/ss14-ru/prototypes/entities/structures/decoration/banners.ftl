...
ent-BannerColorful = разноцветное знамя
    .desc = Это знамя во всех цветах радуги. Или нет...
ent-BannerVampire = вампирское знамя
    .desc = Знамя истинных трансильванских вампиров!
