...
job-description-blueshield = Будучи элитным офицером с ЦК исполняющим роль телохранителя - убедитесь что как можно больше глав доживут до конца смены. Не работайте вместо службы безопасности.
