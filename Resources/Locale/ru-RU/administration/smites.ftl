...
admin-smite-permstun-description = Зарядить батоном
admin-smite-vulpkanin-species-swap-description = Это превращает их в вулпканинов. Полезно для людей, которые были космическими расистами.
admin-smite-itemify-description = Превращает объект в товар, который вы можете забрать.
